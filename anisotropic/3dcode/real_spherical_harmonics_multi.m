...
%
function [f] = real_spherical_harmonics_multi(theta,phi, coeff, degree, dl)
%%=============================================================
...
if (dl==2) 
    ...
    [m,n,k]=size(theta);
    B = zeros(m,n,k,coeff_length);
    Btheta = zeros(m,n,k,coeff_length);
    Bphi = zeros(m,n,k,coeff_length);
else
    if (dl==1) 
